...
const projects = [
  {
    ...
    description: "Repositioning a traditional 20-year-old South India retail brand for digital-first audiences. Focus on heritage, identity shifts, and modern positioning.",
    href: "/portfolio",
    image: "/project-1.png",
  },
  {
    ...
    description: "End-to-end authority building for active startup founders on LinkedIn and Instagram. Zero online footprint converted to 50K+ engaged followers.",
    href: "/portfolio",
    image: "/project-1.png",
  },
  {
    ...
    description: "A comprehensive 12-month digital adoption strategy for traditional B2B businesses entering direct-to-consumer online sales paths.",
    href: "/portfolio",
    image: "/project-1.png",
  }
];
    ...
    <section className="bg-brand-black py-14 md:py-22 container mx-auto px-6 lg:px-20  relative">
      <div className="">
              ...
              return (
                ...
                >
                  ...
                  <Link href={project.href} className="block select-none w-fit">
                    <h3 className={`font-display font-bold text-[26px] md:text-[32px] transition-all duration-300 leading-tight text-brand-white ${isActive ? "lg:translate-x-2 lg:text-brand-white" : "lg:text-brand-white/50"}`}>
                      {project.title}
                    </h3>
                  </Link>
                  ...
                  <div className={`grid transition-all duration-300 ease-in-out grid-rows-[1fr] opacity-100 mt-6 ${isActive ? "lg:grid-rows-[1fr] lg:opacity-100 lg:mt-4" : "lg:grid-rows-[0fr] lg:opacity-0 lg:mt-0"}`}>
                    <div className="overflow-hidden">
                      ...
                      <p className="font-body text-brand-white/60 text-[14px] leading-relaxed max-w-xl">
                        {project.description}
                      </p>
        ...
        <div className="mt-24 text-center">
          <Button href="/portfolio" variant="secondary" className="uppercase tracking-widest text-[11px] py-4 px-8">
